  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        postAction: [
          "bg-transparent text-[#666666] hover:bg-[#f3f2ef]",
          "rounded-lg py-2 md:py-3 p-6 md:px-2 w-full",
          "transition-colors duration-200",
          "shadow-none hover:shadow-none",
          "hover:text-[#0a66c2]",
          "[&_svg]:transition-colors [&_svg]:duration-200",
          "hover:[&_svg]:text-[#0a66c2]",
          "active:bg-[#e1e1e1]",
          "font-medium",
          "border-none",
          "focus:bg-[#f3f2ef] focus:text-[#0a66c2]",
          "group",
          "flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 ",
          "text-[10px] md:text-xs",
          "[&_svg]:h-4 [&_svg]:w-4 md:[&_svg]:h-5 md:[&_svg]:w-5",
          "data-[state=selected]:bg-[#e1e1e1]",
          "data-[state=selected]:text-[#0a66c2]",
        ].join(" "),
        edit: [
